...
export const easingFunctions = {
  ...
  bounceInOut(t) {
    return (
      ((t *= 2) <= 1
        ? 1 - easingFunctions.bounceOut(1 - t)
        : easingFunctions.bounceOut(t - 1) + 1) / 2
    )
  },
}
